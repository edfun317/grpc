...
type GreeterClient interface {
	...
	SayHellos(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloReply], error)
	// Client Streaming: Receives multiple greetings
	ReceiveHellos(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloReply], error)
...
type Greeter_SayHellosClient = grpc.ServerStreamingClient[HelloReply]

func (c *greeterClient) ReceiveHellos(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], Greeter_ReceiveHellos_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[HelloRequest, HelloReply]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_ReceiveHellosClient = grpc.ClientStreamingClient[HelloRequest, HelloReply]
...
type GreeterServer interface {
	...
	// Client Streaming: Receives multiple greetings
	ReceiveHellos(grpc.ClientStreamingServer[HelloRequest, HelloReply]) error
	// Bidirectional Streaming: Chat service
...
func (UnimplementedGreeterServer) SayHellos(*HelloRequest, grpc.ServerStreamingServer[HelloReply]) error {
	return status.Errorf(codes.Unimplemented, "method SayHellos not implemented")
}
func (UnimplementedGreeterServer) ReceiveHellos(grpc.ClientStreamingServer[HelloRequest, HelloReply]) error {
	return status.Errorf(codes.Unimplemented, "method ReceiveHellos not implemented")
}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_SayHellosServer = grpc.ServerStreamingServer[HelloReply]

func _Greeter_ReceiveHellos_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).ReceiveHellos(&grpc.GenericServerStream[HelloRequest, HelloReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_ReceiveHellosServer = grpc.ClientStreamingServer[HelloRequest, HelloReply]
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ReceiveHellos",
			Handler:       _Greeter_ReceiveHellos_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "Chat",
